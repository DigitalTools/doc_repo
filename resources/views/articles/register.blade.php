        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register_article') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea rows="10" id="body" class="form-control" name="body"></textarea>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-ticket"></i> Register Article
                                </button>
                            </div>
                        </div>
                    </form>
